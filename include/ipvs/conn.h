...
enum {
    ...
    DPVS_CONN_F_CSUM_IPOL_IN    = 0x4000,
    DPVS_CONN_F_CSUM_TCPOL_IN   = 0x8000,
    DPVS_CONN_F_CSUM_UDPOL_IN   = 0x10000,
    DPVS_CONN_F_CSUM_IPOL_OUT   = 0x20000,
    DPVS_CONN_F_CSUM_TCPOL_OUT  = 0x40000,
    DPVS_CONN_F_CSUM_UDPOL_OUT  = 0x80000,
};
...
#define DPVS_CONN_FS_MAGIC  0x55DEADBEEFAA
struct dp_vs_conn {
    int                     af;
    uint8_t                 proto;
