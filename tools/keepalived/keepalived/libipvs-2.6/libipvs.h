...
#define OPT_LCORE_ID            0x20000000
#define OPT_MCAST_GROUP         0x40000000
#define OPT_MCAST_PORT          0x80000000
#define OPT_MCAST_TTL           0x100000000
#define OPT_MCAST_IFADDESS      0x200000000
...
typedef struct lb_sync_daemon_entry	ipvs_daemon_t;
...
extern int ipvs_update_service_by_options(ipvs_service_t *svc, uint64_t options);
...
/* set a connection synchronizaiton daemon */
extern int ipvs_set_daemon(ipvs_daemon_t *dm);
...
extern struct lb_sync_daemon_stats *ipvs_get_daemon(void);
